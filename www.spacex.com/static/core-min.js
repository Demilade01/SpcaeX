...
const limit = header.hasAttribute("data-limit") ? header.getAttribute("data-limit") : .45
  ...
  , addIO = ()=>{
    ...
    const n = new IntersectionObserver(t=>{
        let o = 0;
        t.forEach((t,n)=>{
            const s = t.boundingClientRect.y
              , i = t.intersectionRatio
              , r = a.find(e=>e.el === t.target)
              , d = .15 * o;
            if (i > r.ratio) {
                if (r.animated)
                    return;
                const a = 0 === r.y || s < r.y ? e : -e;
                r.animated = !0,
    ...
    const s = query("#stats .content-center");
        ...
        queryAll(".slider").forEach(e=>{
            ...
            if (o && n && !e.hasAttribute("data-arrow-noresize")) {
                const t = e.querySelector(".js-bounding")
                  ...
                  , i = t.getBoundingClientRect().top - s.top + 9 + 10;
